/*
 * WebGL fluid simulation adapted from Pavel Dobryakov
...
const useFluidCursor = () => {
 ...
 const pastels = [
 { h: 0.97, s: 0.42, v: 0.92 }, // peach pink
 { h: 0.92, s: 0.38, v: 0.9 }, // pale rose
 { h: 0.38, s: 0.4, v: 0.88 }, // mint
 { h: 0.55, s: 0.36, v: 0.9 }, // sky blue
 { h: 0.72, s: 0.4, v: 0.88 }, // lavender
 { h: 0.13, s: 0.4, v: 0.92 }, // butter yellow
 ];
 const pick = pastels[Math.floor(Math.random() * pastels.length)];
 const c = HSVtoRGB(pick.h, pick.s, pick.v);
 c.r *= 0.12;
 c.g *= 0.12;
 c.b *= 0.12;
 return c;
